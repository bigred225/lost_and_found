...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference("Claim.count") do
      post claims_url, params: { claim: { expiration_date: @claim.expiration_date, found_item_id: @claim.found_item_id, user_id: @claim.user_id } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { expiration_date: @claim.expiration_date, found_item_id: @claim.found_item_id, user_id: @claim.user_id } }
