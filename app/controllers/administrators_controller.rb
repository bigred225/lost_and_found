class AdministratorsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @administrator.update(administrator_params)
        format.html { redirect_to @administrator, notice: "Administrator was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to administrators_path, notice: "Administrator was successfully destroyed.", status: :see_other }
